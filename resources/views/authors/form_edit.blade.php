  ...
  <div class="row ">
   ...
   <div class="nav-tabs-custom" align="" id="my_tab">
                <ul class="nav nav-tabs pull-right">
                  ...
                  <li class="pull-left header"><i class="fa fa-inbox"></i> Editar Autores</li>
                </ul>
...
<div class="row">
  ...
  <div class="form-group" align="center">
                        <img ng-src="@{{author.imagen}}" alt="" class="img-thumbnail"/>
                       </div>
   </div>
  ...
  <div class="">
    ...
    <div ng-show="show" >
     ...
     <div class="box-footer">
                    <button type="submit" class="btn btn-primary" aling="left" ng-click="updateAuthor()">Modificar</button>
  ...
  <div class="box-footer" aling="right">
                    <button type="submit" class="btn btn-primary" ng-click="updateAuthor()">Modificar</button>
                    <a href="/authors" class="btn btn-danger">Cancelar</a>
                     <!--<input type="button" class="btn btn-danger" value="Cancel"onclick="location='/authors'"/>-->
                  </div>
