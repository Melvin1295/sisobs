        	...
        	<div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="timeline">
                        ...
                        <div class="blog-post">
                        	<div class="blog-info">
                            	<img src="assets/images/avatar_01.jpg" class="img-responsive" alt="">
                        ...
                        <div class="blog-post">
                        	<div class="blog-info">
                            	<img src="assets/images/avatar_02.jpg" class="img-responsive" alt="">
                                <div class="date"><div class="number">09</div><div>Dec</div></div>
                            </div>
                            <h3><a href="blogitem.html">Nature Center: Earth Day Festival</a></h3>
                            <p><img class="img-responsive pull-right" src="assets/images/image_02.JPG" alt="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In venenatis lacus ac semper viverra. Etiam consequat odio sollicitudin metus condimentum, quis hendrerit erat adipiscing. Cras non turpis ut eros varius laoreet a ut felis. Aliquam sodales, purus pulvinar tincidunt congue, elit mauris sodales nisl, consequat iaculis urna enim in lectus. Proin at ornare lacus.</p>
                        	<ul class="blog-tags list-unstyled list-inline">
                                <li><a href=""><i class="fa fa-tag"></i>book</a></li>
                                <li><a href=""><i class="fa fa-tag"></i>music</a></li>
                                <li><a href=""><i class="fa fa-tag"></i>nature</a></li>
                        ...
                        <div class="blog-post">
                        	<div class="blog-info">
                            	<img src="assets/images/avatar_03.jpg" class="img-responsive" alt="">
                            ...
                            <p><img class="img-responsive pull-right" src="assets/images/image_03.JPG" alt="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In venenatis lacus ac semper viverra. Etiam consequat odio sollicitudin metus condimentum, quis hendrerit erat adipiscing. Cras non turpis ut eros varius laoreet a ut felis. Aliquam sodales, purus pulvinar tincidunt congue, elit mauris sodales nisl, consequat iaculis urna enim in lectus. Proin at ornare lacus.</p>
                        	<ul class="blog-tags list-unstyled list-inline">
                                <li><a href=""><i class="fa fa-tag"></i>book</a></li>
                                <li><a href=""><i class="fa fa-tag"></i>music</a></li>
                                <li><a href=""><i class="fa fa-tag"></i>nature</a></li>
                        ...
                        <div class="blog-post">
                        	<div class="blog-info">
                            	<img src="assets/images/avatar_04.jpg" class="img-responsive" alt="">
                                <div class="date"><div class="number">19</div><div>Nov</div></div>
                            </div>
                            <h3><a href="blogitem.html">We Have Moved to a New Office</a></h3>
                            <p><img class="img-responsive pull-right" src="assets/images/image_04.JPG" alt="">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In venenatis lacus ac semper viverra. Etiam consequat odio sollicitudin metus condimentum, quis hendrerit erat adipiscing. Cras non turpis ut eros varius laoreet a ut felis. Aliquam sodales, purus pulvinar tincidunt congue, elit mauris sodales nisl, consequat iaculis urna enim in lectus. Proin at ornare lacus.</p>
                        	<ul class="blog-tags list-unstyled list-inline">
                                <li><a href=""><i class="fa fa-tag"></i>book</a></li>
                                <li><a href=""><i class="fa fa-tag"></i>music</a></li>
                                <li><a href=""><i class="fa fa-tag"></i>nature</a></li>
